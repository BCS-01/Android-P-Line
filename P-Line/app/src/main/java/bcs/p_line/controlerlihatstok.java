...
public class controlerlihatstok extends AsyncTask<String, String, String> {
    ...
    public controlerlihatstok(waintlist listener) {
    ...
    protected void onPostExecute(String sJson) {
        ...
        try {
            ...
            for(int i=0; i<aJson.length(); i++) {
                ...
                app.setPotong(json.getString("stok"));
