...
public class Signpenjual {
    ...
    public Signpenjual(Context context, bcs.p_line.Listener listener) {
    ...
    public void doSignIn() {
        ...
        new AsyncTask<Void, Void, String>() {
            ...
            protected String doInBackground(Void... params) {
                String msg = "";
                try {
                    logger.logInfo(TAG, constants.cekidruko);
                    msg = utils.passDataToServer(constants.cekidruko, nameValuePairs);
                } catch (Exception ex) {
                }
                return msg;
            }
